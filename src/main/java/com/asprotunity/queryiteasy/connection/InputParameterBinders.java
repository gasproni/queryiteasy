...
public class InputParameterBinders {
    ...
    public static InputParameter bind(String value) {
        return (statement, position, statementCloser) -> RuntimeSQLException.execute(() ->
                statement.setString(position, value));
    }

    public static InputParameter bind(Short value) {
        return (statement, position, statementCloser) ->
        ...
        return (statement, position, statementCloser) -> {
            ...
            RuntimeSQLException.execute(() -> {
                if (inputStream == null) {
                    ...
                    statementCloser.onLeave(inputStream::close);
